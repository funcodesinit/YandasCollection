    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        ...
        try {
            ...
            if (signin?.error) {
                ...
                setServerError("Invalid Credentials, please check your phone number and password.");
                setLoading(false); // Reset loading state when error occurs
            } else {
                console.log("Form Submitted with values:",
                    `Phone Number: ${values.email}`,
                    `Password: ${values.password}`
                ); 
                // After successful login, redirect the user to the business admin page
                setLoading(false); // Reset loading state on success
                router.push('business/customers');  // Uncomment if using Next.js Router                                                                                                                                                                                                                                                                                                                                                                                                 
            } 
        } catch (err) {
                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px] ">
                            <div className="bg-white space-y-6 px-6 py-12 shadow-sm sm:rounded-lg gap-10 sm:px-12">
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <button
                                        type="button" disabled={isSubmitting} onClick={()=>router.push('/signup')}
