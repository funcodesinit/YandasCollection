...
// const validationSchema = Yup.object({
//   productId: Yup.number(),
//   productImageId: Yup.string().required("image name is required"),
...
//     const sizeId = selectedSize.size.id;

//     setCart((prev) => {
//       const currentQty = prev[colorId]?.[sizeId] || 0;
//       const updatedSizes = {
//         ...(prev[colorId] || {}),
//         [sizeId]: currentQty + quantity,
//       };
//       return {
//         ...prev,
...
//                       prevImages.map((img) =>
//                         img.productImageId === selectedColor.id.toString()
//                           ? {
//                               ...img,
//                               size: [{ sizeId: size.size.id.toString(), quantity }],
//                             }
//                           : img
//                       )
//                     );
...
//                   <div className="mt-4">
//                     <h3 className="text-sm text-gray-600">Size</h3>
//                     <RadioGroup value={selectedSize} onChange={setSelectedSize} className="mt-2 grid grid-cols-3 gap-3">
//                       {selectedColor.stock.map((stockObj: any) => (
//                         <RadioGroup.Option
//                           key={stockObj.size.id}
//                           value={stockObj}
...
//                     disabled={outOfStock}
//                     className={classNames(
//                       outOfStock ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700',
//                       'flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent px-8 py-3 text-base font-medium text-white focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-full'
//                     )}>
